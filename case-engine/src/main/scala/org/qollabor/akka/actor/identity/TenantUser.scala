...
import org.qollabor.akka.actor.serialization.json.{BooleanValue, Value, ValueMap}
import org.qollabor.infrastructure.json.QollaborJson

import scala.collection.mutable

final case class TenantUser(id: String, roles: Seq[String], tenant: String, isOwner: Boolean = false, name: String, email: String = "", enabled: Boolean = true) extends QollaborSerializable with QollaborJson {
