...
import org.qollabor.akka.actor.serialization.json.{ValueList, ValueMap}
import org.qollabor.cmmn.akka.command.team
import org.qollabor.cmmn.definition.CaseDefinition
import org.qollabor.cmmn.instance.team.CaseTeamError
import org.qollabor.infrastructure.json.QollaborJson

import scala.collection.JavaConverters._

case class CaseTeam(members: Seq[CaseTeamMember] = Seq(), caseRoles: Seq[String] = Seq(), unassignedRoles: Seq[String] = Seq()) extends QollaborJson {
