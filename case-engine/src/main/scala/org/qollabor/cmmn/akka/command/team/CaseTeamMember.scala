...
import org.qollabor.akka.actor.serialization.json.{BooleanValue, StringValue, Value, ValueMap}
...
case class CaseTeamMember(key: MemberKey, caseRoles: Seq[String] = Seq(), isOwner: Option[Boolean] = None, removeRoles: Seq[String] = Seq()) extends QollaborJson {
