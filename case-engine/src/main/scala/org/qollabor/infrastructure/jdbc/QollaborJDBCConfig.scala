package org.qollabor.infrastructure.jdbc
...
import slick.migration.api.org.qollabor.infrastructure.jdbc.sqlserver.SQLServerDialect
...
trait QollaborJDBCConfig {
  ...
  abstract class QollaborTable[T](tag: Tag, tableName: String) extends Table[T](tag, tableName) {
  ...
  implicit class QueryHelper[T <: QollaborTable[_], E](query: Query[T, E, Seq]) {
    /**
