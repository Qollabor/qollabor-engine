...
import org.qollabor.akka.actor.serialization.{QollaborSerializable, Fields}
import org.qollabor.akka.actor.serialization.json.{BooleanValue, StringValue, ValueList, ValueMap}
import org.qollabor.infrastructure.json.QollaborJson

final case class TenantUserInformation(id: String, roles: Option[Seq[String]] = None, name: Option[String] = None, email: Option[String] = None, owner: Option[Boolean] = None, enabled: Option[Boolean] = None) extends QollaborSerializable with QollaborJson {
