...
import org.qollabor.akka.actor.handler.AkkaSystemMessageHandler;
...
public class TimerService extends ModelActor<TimerServiceCommand, ModelEvent> {
    ...
    public static final String QOLLABOR_TIMER_SERVICE = "qollabor-timer-service";
