...
import org.qollabor.akka.actor.handler.*;
...
import org.qollabor.cmmn.akka.event.file.CaseFileEvent;
import org.qollabor.cmmn.akka.event.plan.PlanItemEvent;
import org.qollabor.cmmn.instance.debug.DebugJsonAppender;
...
public abstract class ModelActor<C extends ModelCommand, E extends ModelEvent> extends AbstractPersistentActor {
     ...
     * If a ModelActor is recovered by Akka, then the version will be overwritten in {@link ModelActor#setEngineVersion(QollaborVersion)}.
     ...
     */
    private QollaborVersion engineVersion;
    ...
    public QollaborVersion getEngineVersion() {
        return this.engineVersion;
    }

    public void setEngineVersion(QollaborVersion version) {
