...
import org.qollabor.akka.actor.serialization.json.JSONParseFailure;
import org.qollabor.akka.actor.serialization.json.JSONReader;
...
public class QollaborSerializer extends SerializerWithStringManifest {
    private final static Logger logger = LoggerFactory.getLogger(QollaborSerializer.class);

    /**
     * The unique identifier for the QollaborSerializer (value is <code>424242</code>)
     */
    ...
    protected QollaborSerializer() {
    }

    protected QollaborSerializer(ExtendedActorSystem system) {
    }
    ...
    public String manifest(Object o) {
        if (o instanceof QollaborSerializable) {
        ...
        throw new RuntimeException("The Akka Case Object Serializer can only serialize objects implementing QollaborSerializable");
    }

    @Override
    public byte[] toBinary(Object o) {
        if (o instanceof QollaborSerializable) {
            QollaborSerializable target = (QollaborSerializable) o;
