...
public interface QollaborSerializable {
    Logger logger = LoggerFactory.getLogger(QollaborSerializer.class);
    ...
    /**
     * Writes this QollaborSerializable object with a start and end object. In between invokes the write method.
     * @param generator
     * @throws IOException
     */
    ...
    default void writeListField(JsonGenerator generator, Fields fieldName, Collection<? extends QollaborJson> stringList) throws IOException {
        generator.writeArrayFieldStart(fieldName.toString());
        for (QollaborJson string : stringList) {
            if (string == null) {
                generator.writeNull();
            } else {
    ...
    default void writeField(JsonGenerator generator, Fields fieldName, QollaborSerializable value) throws IOException {
        if (value == null) {
            generator.writeNullField(fieldName.toString());
        } else {
            generator.writeFieldName(fieldName.toString());
