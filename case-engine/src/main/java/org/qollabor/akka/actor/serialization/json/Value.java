...
public abstract class Value<T> implements Serializable {
    ...
    public static Value<?> convert(Object object) {
        // NOTE: order of if statements is measured by running Qollabor TypeScript test framework;
        ...
        if (object == null) {
            ...
            return valueList;
        } else if (object instanceof QollaborJson) {
            return ((QollaborJson) object).toValue();
