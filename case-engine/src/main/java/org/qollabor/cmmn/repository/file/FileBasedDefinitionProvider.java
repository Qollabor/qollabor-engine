...
import org.qollabor.cmmn.repository.WriteDefinitionException;
...
public class FileBasedDefinitionProvider implements DefinitionProvider {
     ...
     * The directory can be configured through the Typesafe config setting 'qollabor.definitions.location'
