...
import org.qollabor.cmmn.definition.casefile.ImportDefinition;
...
public class DefinitionsDocument implements Serializable {
    ...
    /**
     * Returns the first case in the definitions file. Typically the main case when deployed using Qollabor IDE
     *
