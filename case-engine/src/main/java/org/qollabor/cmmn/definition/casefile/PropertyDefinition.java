...
public class PropertyDefinition extends CMMNElementDefinition {
    ...
    private boolean readBusinessIdentifiership() {
        Element qollaborImplementation = getExtension("implementation", false);
        if (qollaborImplementation == null) {
            return false;
        }
        String value = qollaborImplementation.getAttribute("isBusinessIdentifier");
