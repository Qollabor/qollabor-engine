...
import org.qollabor.infrastructure.cqrs.{OffsetRecord, OffsetStorage, OffsetStorageProvider}
...
trait OffsetStoreTables extends QueryDBSchema {
  ...
  final class OffsetStoreTable(tag: Tag) extends QollaborTable[OffsetRecord](tag, "offset_storage") {
