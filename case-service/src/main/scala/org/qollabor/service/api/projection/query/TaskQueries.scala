...
import org.qollabor.akka.actor.serialization.json.{LongValue, Value, ValueMap}
import org.qollabor.infrastructure.jdbc.query.{Area, Sort}
import org.qollabor.infrastructure.json.QollaborJson
import org.qollabor.service.api.projection.record.TaskRecord
import org.qollabor.service.api.projection.{CaseSearchFailure, TaskSearchFailure}

import scala.concurrent.Future

case class TaskCount(claimed: Long, unclaimed: Long) extends QollaborJson {
