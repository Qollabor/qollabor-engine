package org.qollabor.service.api.projection.record

import java.time.Instant

import org.qollabor.akka.actor.serialization.json.{JSONReader, Value, ValueList, ValueMap}
import org.qollabor.cmmn.definition.{CaseDefinition, DefinitionsDocument}
...
final case class CaseRecord(id: String,
                            ...
                            createdBy: String = "",
                            caseInput: String = "",
                            caseOutput: String = "") extends QollaborJson {
...
final case class PlanItemHistoryRecord(id: String,
                                       ...
                                       taskOutput: String = "",
                                       mappedInput: String = "",
                                       rawOutput: String = "") extends QollaborJson {
