...
import org.qollabor.service.api.projection.record.{TenantRecord, UserRoleKey, UserRoleRecord}
import org.qollabor.service.api.projection.slick.SlickTransaction
import org.qollabor.tenant.akka.event._
import org.qollabor.tenant.akka.event.platform.{PlatformEvent, TenantCreated, TenantDisabled, TenantEnabled}
