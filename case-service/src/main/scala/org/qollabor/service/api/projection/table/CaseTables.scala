...
trait CaseTables extends QueryDBSchema {
  ...
  class CaseInstanceTable(tag: Tag) extends QollaborTable[CaseRecord](tag, "case_instance") {
  ...
  final class CaseInstanceDefinitionTable(tag: Tag) extends QollaborTable[CaseDefinitionRecord](tag, "case_instance_definition") {
  ...
  class PlanItemTable(tag: Tag) extends QollaborTable[PlanItemRecord](tag, "plan_item") {
  ...
  final class PlanItemHistoryTable(tag: Tag) extends QollaborTable[PlanItemHistoryRecord](tag, "plan_item_history") {
  ...
  class CaseFileTable(tag: Tag) extends QollaborTable[CaseFileRecord](tag, "case_file") {
  ...
  final class CaseBusinessIdentifierTable(tag: Tag) extends QollaborTable[CaseBusinessIdentifierRecord](tag, "case_business_identifier") {
  ...
  class CaseInstanceRoleTable(tag: Tag) extends QollaborTable[CaseRoleRecord](tag, "case_instance_role") {
  ...
  class CaseInstanceTeamMemberTable(tag: Tag) extends QollaborTable[CaseTeamMemberRecord](tag, "case_instance_team_member") {
